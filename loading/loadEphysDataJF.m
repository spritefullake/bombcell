...
integer_spike_times = readNPY([ephys_path filesep  'spike_times.npy']);
spike_times = double(integer_spike_times) ./ ephys_sample_rate;
...
ephysData.integer_spike_times = integer_spike_times
end